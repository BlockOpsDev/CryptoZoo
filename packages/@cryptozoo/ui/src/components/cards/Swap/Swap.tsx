  ...
  const tokenSelectPopup = (
    ...
    >
      <div className="max-w-[95vw] h-[95vh] w-[500px] relative">
        <button className="absolute top-2 right-2 z-10 text-secondary-text" onClick={closeModal}>
          <FaTimes size={20} />
        </button>
            ...
            <Card layer={3} className="w-full p-4 pb-6">
              <div className="flex flex-col gap-2">
                <div className="flex gap-2 items-center justify-center flex-wrap">
                  {/* {tokenSelectPopup} */}
                  <button className="rounded-full bg-secondary px-4 py-1 w-full tablet:w-fit" onClick={() => setOpen(true)}>Select Token</button>
